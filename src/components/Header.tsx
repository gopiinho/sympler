...
export function Header() {
  return (
    <header className='max-xl: mx-auto flex w-full items-center justify-between gap-4 border-b-[0.04px] border-foreground ~py-4/5 max-lg:max-h-20 lg:w-[15%] lg:flex-col lg:rounded-r-2xl lg:border-[0.4px]'>
      <LinkComponent href='/'>
