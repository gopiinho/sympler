...
export default function Home() {
  return (
    <div className='font-trap flex h-full w-full flex-col content-center items-center justify-center gap-8 py-10 text-center ~px-4/8'>
      <div className='grid gap-6'>
        <h1 className='font-nats select-none font-semibold leading-[0.6] ~text-5xl/[7rem]'>
